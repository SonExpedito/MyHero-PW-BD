            ...
            <div class="form-value">
                ...
                <form action="" method="POST">
                    ...
                    <div class="inputbox">
                        ...
                        <input name="idlivro" type="text" size="40" value='<?php echo $pro_mostrar[0]?>' maxlength="40"  readonly>
                        <label for="">ID-Livro</label>
                    </div>

                    <div class="inputbox">
                        <i class='bx bx-book'></i>
                        <input name="idautor" type="text" size="40" value='<?php echo $pro_mostrar[1]?>' maxlength="40"  readonly>
                    ...
                    <div class="inputbox">
                        <i class='bx bx-book'></i>
                        <input name="txteditora" type="text" size="40" value='<?php echo $pro_mostrar[2]?>' maxlength="40"  >
