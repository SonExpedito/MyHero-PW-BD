            ...
            <div class="form-value">
                ...
                <form action="" method="POST">
                    ...
                    <div class="inputbox">
                        ...
                        <input name="idautor" type="text" size="5" value='<?php echo $pro_mostrar[0]?>' maxlength="5" readonly >
                    ...
                    <div class="inputbox">
                        ...
                        <input name="txtsobrenome" type="text" size="50" value='<?php echo $pro_mostrar[2]?>' maxlength="50" >
                    ...
                    <div class="inputbox">
                        <i class='bx bx-book'></i>
                        <input name="txtnacionalidade" type="text" size="40" value='<?php echo $pro_mostrar[4]?>' maxlength="40"  >
                        <label for="">Nacionalidade-Autor</label>
                    </div>

                    <div class="inputbox">
                        <i class='bx bxs-discount' ></i>
                        <input name="emailtxt" type="text" size="50" value='<?php echo $pro_mostrar[5]?>' maxlength="50">
