                ...
                <form action="" method="POST">
                    ...
                    foreach ($pro_bd as $pro_mostrar) {
                        ...
                        <div class="inputbox">
                            ...
                            <input name="idlivro" type="text" size="5" value='<?php echo $pro_mostrar[0] ?>' maxlength="5"
                                readonly>
                        ...
                        <div class="inputbox">
                            <i class='bx bx-book'></i>
                            <input name="txttitulo" type="text" size="30" value='<?php echo $pro_mostrar[1] ?>'
                                maxlength="30">
                        ...
                        <div class="inputbox">
                            <i class='bx bxs-discount'></i>
                            <input name="txtcategoria" type="text" size="30" value='<?php echo $pro_mostrar[3] ?>'
                                maxlength="30">
                        ...
                        <div class="inputbox">
                            <i class='bx bx-book'></i>
                            <input name="txtidioma" type="text" size="30" value='<?php echo $pro_mostrar[4] ?>'
                                maxlength="30">
                    ...
                    <div class="Status">
                        <p>
                            ...
                            if (isset($btnalterar)) {
                                ...
                                $pro->alterar2();
                                echo '<script>setTimeout(function() { window.location.href = "AlterarLivro.php"; });</script>';
                            }
